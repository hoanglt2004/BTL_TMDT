              ...
              <div class="col-md-6">
                ...
                <div class="table-responsive">
                  <table class="table table-sm table-borderless mb-0">
                    <tbody>
                      <tr>
                        <th class="pl-0 w-25" scope="row"><strong>Category ID</strong></th>
                        <td>${detail.cateID}</td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <div class="col-md-6 col-lg-3 mb-5">
                  ...
                  <div class="">
                    ...
                    <div class="pt-4">
                      ...
                      <h5>${o.brand }</h5>
                      <p><span class="text-danger mr-1"><strong>${String.format("%.02f",o.price*0.9)
                            }$</strong></span><span class="text-grey"><strong><s>${o.price }$</s></strong></span></p>
