                    ...
                    <tbody>
                      <c:forEach items="${listP}" var="o">
                        <tr>
                          ...
                          <td>${o.price} $</td>
                          <td>
                            <a href="loadProduct?pid=${o.id}"><button type="button"
                                class="btn btn-warning btn-action"><i class="fa fa-edit"></i></button></a>
                            <a href="delete?pid=${o.id}"><button type="button" class="btn btn-danger btn-action"><i
